 ...
 */
public class SearchId extends javax.swing.JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
      ...
      if (ae.getActionCommand()=="Search") {
            try {
                ...
                ResultSet rs=stmt.executeQuery("select * from record where Student_ID='"+st+"'");
                if(rs.next()){
...
//                    se.emi.setText(rs.getString(9));
                    ...
                    setVisible(false);
                     ...
                     JOptionPane.showMessageDialog(this, "Please Enter Correct Student Id", "Error", JOptionPane.WARNING_MESSAGE);
                   txt.setText("");
                }      
